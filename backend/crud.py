...
def get_user_by_email(db: Session, email: str):
    ...
    """
    return db.query(backend.models.User).filter(backend.models.User.email == email).first()
...
def get_user_by_id(db: Session, user_id: int):
    ...
    """
    return db.query(backend.models.User).filter(backend.models.User.id == user_id).first()
